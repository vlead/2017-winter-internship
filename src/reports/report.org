...
* Objectives
** Convert an Experiment in Colloid and Surface Chemistry lab
   Experiment 3 present in Colloid and Surface Chemistry lab is to converted
...
** Fix the freshly created issues in Colloid and Surface Chemistry lab
   The Colloid and Surface Chemistry had issues which were created while
...
** Deploy the Colloid and Surface Chemistry lab
   Needed to deploy the Colloid and Surface Chemistry lab after fixing all the
   issues in it.

* Project repositories
** Colloid and Surface Chemistry lab
   The repository can be found [[https://github.com/integration-team-iiith/colloid-and-surface-chemistry-iiith-javascript-lab][here]].
...
** College Cloud Documentation
   The repository can be found [[https://github.com/blazingeagle1002/College-Cloud-Documentation][here]].

* Outcome of Internship
** Conversion of Experiment in Colloid and Surface Chemistry lab
   The Experiment 3 of Colloid and Surface Chemistry lab is 
   successfullly converted into JavaScript from Flash. It took
   5 days for the conversion and fixing some errors in the 
   Experiment.

** Fixing issues of Physical Chemistry Responsive lab
   Fixed 30 issues present the Physical-Chemistry-Responsive
   lab. 6 issues were left. These might take 1-2 days for fixing.
   
** Fixing freshly created issues of Colloid and Surface Chemistry lab
   Fixed the 60 issues present in the Colloid and Surface Chemistry lab.
